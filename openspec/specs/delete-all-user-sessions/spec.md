...
Allows an authenticated user to bulk-delete (soft-delete) all of their chat sessions in a single request, regardless of which media the sessions are associated with.
