...
Defines the behaviour of the `GET /v1/sources/{sourceId}` endpoint, which returns detailed information for a single source when the authenticated user has access rights.
