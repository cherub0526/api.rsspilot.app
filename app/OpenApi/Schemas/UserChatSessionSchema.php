...
#[OAT\Schema(
    ...
    properties: [
        ...
        new OAT\Property(property: 'message_count', type: 'integer', example: 12),
        new OAT\Property(property: 'media', ref: MediaResource::class, nullable: true),
        new OAT\Property(
