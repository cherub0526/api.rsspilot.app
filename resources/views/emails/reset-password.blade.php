<!doctype html>
<html lang="zh-Hant" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
                                ...
                                <td align="center" style="padding-bottom:24px;">
                                    ...
                                    <div style="display:inline-block;width:64px;height:64px;background-color:#eef2ff;border-radius:14px;text-align:center;line-height:64px;">
                                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                            ...
                                            <path d="M8 12V8.5a6 6 0 0 1 12 0V12" stroke="#4f46e5" stroke-width="1.75"
                                                  stroke-linecap="round" stroke-linejoin="round"/>
                                            <rect x="4" y="12" width="20" height="13" rx="3" fill="#4f46e5"
                                                  opacity="0.12"/>
                                            <rect x="4" y="12" width="20" height="13" rx="3" stroke="#4f46e5"
                                                  stroke-width="1.75"/>
                                            <circle cx="14" cy="18.5" r="2" fill="#4f46e5"/>
                                            <line x1="14" y1="20.5" x2="14" y2="22.5" stroke="#4f46e5"
